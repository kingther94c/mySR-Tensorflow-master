...
with tf.variable_scope("Deconvolution"):
    ...
    Y_ = tf.nn.conv2d_transpose(z_Exp,W_Deconv, output_shape, strides=[1,3,3,1], padding='SAME')+b_Deconv
...
##############################################
def train(step_save=step_save,step_train=2000,train_continue = False,learning_rate = LEARNING_RATE,loss='Mix',loss_lambda = loss_lambda,op = 'Adam'):
